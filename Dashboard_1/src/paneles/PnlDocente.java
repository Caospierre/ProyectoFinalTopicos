...
public class PnlDocente extends javax.swing.JPanel {
    ...
    public PnlDocente() {
        ...
        Utils.printTable((DefaultTableModel) this.jt3.getModel(), con.mapeoResultados(new Docente().horarioDelDocente()),4);
        Utils.printTable((DefaultTableModel) this.jt4.getModel(), con.mapeoResultados(new Docente().materiasDelDocente()),2);
    }
    ...
    private void initComponents() {
        ...
        add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 380, 480, 250));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       Utils.printTable((DefaultTableModel) this.jt1.getModel(), new Coneccion().mapeoResultados(new Docente().parametroHorarioDelDocente(this.jinput1.getText())),4);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       Utils.printTable((DefaultTableModel) this.jt2.getModel(), new Coneccion().mapeoResultados(new Docente().parametroMateriasDelDocente(this.jinput2.getText())),2);
